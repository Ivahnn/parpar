...
public class batanes implements Initializable {
    ...
    private void initializeTables() {
        ...
        predefinedActivities.addAll(
                new Activity("Biking around Basco", "", false),
                new Activity("Hiking Marlboro Hills", "", false),
                new Activity("Island Hopping to Sabtang and Itbayat", "", false),
                new Activity("Swimming at Homoron Blue Lagoon", "", false),
                new Activity("Exploring Ivana Port", "", false)
        );
        ...
        mealsactivities.addAll(
                new Activity("Tatus (Coconut Crab) at Honesty Coffee Shop", "", false),
                new Activity("Vunong (Flying Fish) at House of Dakay", "", false),
                new Activity("Uved Balls (Banana Heart Patties) near Mt. Iraya", "", false),
                new Activity("Turmeric Rice with Binungey (Rice Cake) at Chawa View Deck", "", false),
                new Activity("Lukon (Dried Flying Fish) with Ivatan Breakfast Spread at Chamantad-Tinyan Viewpoint", "", false),
                new Activity("Traditional Sinapot (Coconut Crab) Dish at Local Eateries", "", false),
                new Activity("Uved (Banana Heart) Soup at Savidug Village", "", false),
                new Activity("Lunis (Sun-Dried Fish) at Sabtang Island", "", false),
                new Activity("Yellow Rice with Luñis (Sun-Dried Fish) and Dibang (Flying Fish) at Valugan Boulder Beach", "", false),
                new Activity("Vunes (Dried Gaby Leaves) Dish at Sabtang Island", "", false),
                new Activity("Coconut Crab (Tatus) Adobo at Magnfred's Place Batanes", "", false),
                new Activity("Grilled Flying Fish (Dibang) at Baletin Hometel", "", false),
                new Activity("Uved (Banana Heart) Soup at Novita House", "", false),
                new Activity("Traditional Vunong (Flying Fish) at Troy Lodge", "", false),
                new Activity("Lunis (Sun-Dried Fish) with Uved (Banana Heart) at D' Islanders Hotel and Restaurant", "", false)
        );
    ...
    private void saveToDatabase() {
        ...
        try (Connection connection = DriverManager.getConnection(url, user, password)) {
            ...
            itineraryStatement.setString(2, "Batanes");
