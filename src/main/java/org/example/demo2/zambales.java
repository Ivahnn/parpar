...
public class zambales implements Initializable {
    ...
    private void initializeTables() {
        ...
        predefinedActivities.addAll(
                new Activity("Hiking to Anawangin Cove", "", false),
                new Activity("Island Hopping to Capones Island", "", false),
                new Activity("Trekking Mount Pinatubo", "", false),
                new Activity("Snorkeling in Subic Bay", "", false),
                new Activity("Camping at Nagsasa Cove", "", false)
        );
        ...
        mealsactivities.addAll(
                new Activity("Longganisa Zambaleno", "", false),
                new Activity("Tapsilog", "", false),
                new Activity("Daing na Bangus", "", false),
                new Activity("Pancit Batil Patong", "", false),
                new Activity("Churros con Tsokolate", "", false)
        );
    ...
    private void saveToDatabase() {
        ...
        try (Connection connection = DriverManager.getConnection(url, user, password)) {
            ...
            itineraryStatement.setString(2, "Zambales");
