...
public class bohol implements Initializable {
        ...
        executorService.submit(() -> {
            Platform.runLater(() -> {
                hotelComboBox.getItems().addAll(
                        "The Bellevue Resort", "Amorita Resort", "Henann Resort Alona Beach",
                        "Bohol Beach Club", "South Palms Resort Panglao"
                );
            });
        });
    }
    ...
    private void initializeTables() {
        ...
        predefinedActivities.addAll(
                new Activity("Scuba Diving and Snorkeling", "", false),
                new Activity("Chocolate Hills ATV Tour", "", false),
                new Activity("Loboc River Stand-Up Paddleboarding", "", false),
                new Activity("Firefly Watching Tour", "", false),
                new Activity("Island Hopping", "", false)
        );
        ...
        mealsactivities.addAll(
                new Activity("Sikwate and Puto Maya", "", false),
                new Activity("Budbud Kabog", "", false),
                new Activity("Binignit", "", false),
                new Activity("Chorizo de Bohol", "", false),
                new Activity("Tsokolate Tablea", "", false),
                new Activity("Chicken Halang-Halang", "", false),
                new Activity("Tinunuang Isda", "", false),
                new Activity("Pansit Boholano", "", false),
                new Activity("Sutukil", "", false),
                new Activity("Linabog", "", false),
                new Activity("Lechon Boholano", "", false),
                new Activity("Kinilaw", "", false),
                new Activity("Inun-unan", "", false),
                new Activity("Nilubihang Kagang", "", false),
                new Activity("Grilled Squid", "", false)
        );
    ...
    private void playVideo() {
        String videoPath = getClass().getResource("/images/BOHOL.mp4").toExternalForm();
    ...
    private void saveToDatabase() {
        ...
        try (Connection connection = DriverManager.getConnection(url, user, password)) {
            ...
            itineraryStatement.setString(2, "Bohol");
