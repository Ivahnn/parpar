...
public class cebu implements Initializable {
    ...
    private void initializeTables() {
        ...
        predefinedActivities.addAll(
                new Activity("Island Hopping in Mactan", "", false),
                new Activity("Canyoneering at Kawasan Falls", "", false),
                new Activity("Diving in Malapascua", "", false),
                new Activity("Swimming with Whale Sharks in Oslob", "", false),
                new Activity("Hiking Osmeña Peak", "", false)
        );
        ...
        mealsactivities.addAll(
                new Activity("Danggit with Fried Rice and Egg", "", false),
                new Activity("Puto Maya with Sikwate", "", false),
                new Activity("Torta", "", false),
                new Activity("Balbacua", "", false),
                new Activity("Cebu Longganisa", "", false),
                new Activity("Lechon", "", false),
                new Activity("Sinigang na Baboy sa Sampalok", "", false),
                new Activity("Pochero", "", false),
                new Activity("Ginabot", "", false),
                new Activity("Sutukil", "", false),
                new Activity("Baked Scallops", "", false),
                new Activity("Baked Talaba", "", false),
                new Activity("Ginataang Langka with Pork", "", false),
                new Activity("Bam-i", "", false),
                new Activity("Adobong Pusit", "", false)
        );
    ...
    private void saveToDatabase() {
        ...
        try (Connection connection = DriverManager.getConnection(url, user, password)) {
            ...
            itineraryStatement.setString(2, "Cebu");
