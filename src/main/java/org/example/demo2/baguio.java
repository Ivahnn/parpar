...
public class baguio implements Initializable {
    ...
    private void initializeTables() {
        ...
        mealsactivities.addAll(
                new Activity("Strawberry Taho", "", false),
                new Activity("Sagada Coffee", "", false),
                new Activity("Longganisa Baguio", "", false),
                new Activity("Ube Jam", "", false),
                new Activity("Baguio Pandesal", "", false),
                new Activity("Pinikpikan", "", false),
                new Activity("Strawberry Salad", "", false),
                new Activity("Igado", "", false),
                new Activity("Baguio Vegetables Stir-Fry", "", false),
                new Activity("Adobo with Etag", "", false)
        );
    ...
    private void saveToDatabase() {
        ...
        try (Connection connection = DriverManager.getConnection(url, user, password)) {
            ...
            itineraryStatement.setString(2, "Baguio");  // Fixed location
