...
public class siargao implements Initializable {
    ...
    private void initializeTables() {
        ...
        predefinedActivities.addAll(
                new Activity("Surfing at Cloud 9", "", false),
                new Activity("Island Hopping Tour", "", false),
                new Activity("Exploring Sugba Lagoon", "", false),
                new Activity("Swimming in Magpupungko Rock Pools", "", false),
                new Activity("Rope Swinging at Maasin River", "", false)
        );
        ...
        mealsactivities.addAll(
                new Activity("Danggit Lamayo at Taboan Market", "", false),
                new Activity("Chorizo de Cebu at Larsian BBQ", "", false),
                new Activity("Puto Maya with Sikwate", "", false),
                new Activity("Torta Dried Fish and Rice Cake", "", false),
                new Activity("Pusô (Hanging Rice) with Lechon", "", false)
        );
    ...
    private void saveToDatabase() {
        ...
        try (Connection connection = DriverManager.getConnection(url, user, password)) {
            ...
            itineraryStatement.setString(2, "Siargao");
